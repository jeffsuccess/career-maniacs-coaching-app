...
const StoryVault = () => {
  ...
  // Add new story
  const addNewStory = () => {
    setStories([...stories, newStoryTemplate]);
    setSelectedStory(newStoryTemplate.id);
    setEditMode(true);
  };
          ...
          {selectedStory ? (
            <>
              {editMode ? (
                <div>
                  <h2>Edit Story</h2>
                  {/* Edit form would go here in a real implementation */}
            ...
            <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
              ...
              <p>Use the ABT framework to structure your professional stories for maximum impact.</p>
              <button 
                onClick={addNewStory}
                style={{
                  background: 'linear-gradient(90deg, #0AB196, #00C2C7, #16B3F7)',
