...
const Dashboard = () => {
  ...
  const getRecentMindsetPractices = () => {
    const practices = [];
    applicationData.mindsetPractices.forEach(technique => {
    ...
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
                ...
                <div style={{ marginBottom: '0.75rem' }}>
                  {goal.why && (
                    <div style={{ marginBottom: '0.5rem' }}>
                      ...
                      <span style={{ fontSize: '0.9rem' }}>{goal.why}</span>
                    </div>
                  )}
                  ...
                  {goal.implications && (
                    <div>
                      ...
                      <span style={{ fontSize: '0.9rem' }}>{goal.implications}</span>
                    </div>
                  )}
                </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            <h2 style={{ margin: 0 }}>Story Practices</h2>
            <Link 
              to="/storytelling"
              style={{
                color: '#16B3F7',
